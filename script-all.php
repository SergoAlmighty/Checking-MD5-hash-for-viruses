...
// Run the script the very first time, then only run script-yesterday.php
...
// query to get data from database for all.
$query = mysqli_query($conn, "SELECT md5 FROM ".$db_record." ".$where);
